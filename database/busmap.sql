...
--
-- Host: localhost
-- Generation Time: Nov 09, 2012 at 01:51 PM
...
CREATE TABLE IF NOT EXISTS `buspoint` (
  `idbuspoint` int(11) NOT NULL AUTO_INCREMENT,
  `point` int(11) NOT NULL,
  `bus` int(11) NOT NULL,
  PRIMARY KEY (`idbuspoint`,`point`,`bus`),
...
INSERT INTO `buspoint` (`idbuspoint`, `point`, `bus`) VALUES
(1, 3, 15),
(19, 9, 15),
(20, 10, 15),
(21, 11, 15),
...
(3, 'APINAJE', -10.17893573257262, -48.333981743906634, 1, 'Estação Apinajé'),
...
(11, 'P101N-1', -10.1773438129587, -48.33542745456566, 1, ''),
...
(26, 'P206S-3', -10.197605214998331, -48.32210492206127, 1, ''),
